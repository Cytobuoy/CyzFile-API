...
Namespace CytoSettings
    ...
    <Serializable()> Public Class CytoSenseSetting
        ...
        Public ReadOnly Property Laser1Model As String
            Get
                If NumberOfLasers > 0 AndAlso _laserInfo IsNot Nothing AndAlso _laserInfo(0).Uart <> 0 AndAlso _laserInfo(0).DeviceInfo IsNot Nothing Then
        ...
        Public ReadOnly Property Laser1SetDiodeTemperature As Single
            Get
                If NumberOfLasers > 0 AndAlso _laserInfo IsNot Nothing AndAlso _laserInfo(0).Uart <> 0 AndAlso _laserInfo(0).DeviceSettings IsNot Nothing Then
